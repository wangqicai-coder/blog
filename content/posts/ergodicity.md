...
玩1000次？你的财富是初始值的10^(-23)次方——比一个原子还小。
...
[凯利公式](/posts/kelly-criterion/)不是最大化期望收益，而是最大化**几何平均收益**——也就是时间平均。

凯利公式自动考虑了遍历性问题，所以它永远不会让你全押。这也是为什么实践中要使用"半凯利"——因为你对概率的估计可能是错的，需要额外的[安全边际](/posts/margin-of-safety/)。
...
杠杆放大了乘性效应。在非遍历系统中使用杠杆，是在加速归零。这就是[尾部风险](/posts/tail-risk/)如此致命的原因——一次极端事件就足以摧毁一切。
...
- 塔勒布的"[杠铃策略](/posts/barbell-strategy/)"——不是奇技淫巧，是对非遍历性的正确应对
