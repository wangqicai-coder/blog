...
传统决策理论说：计算期望值，选择最高的那个。

凸性思维说：**塑造回报曲线的形状，让你在不知道概率的情况下依然能赢。**

这是完全不同的游戏。

在充满不确定性的世界里，凸性是唯一可靠的优势。

因为概率是可以被改变的——你的判断可能错误，别人可能操纵，世界可能改变。

但数学性质是不变的——凸函数永远从波动中获益，凹函数永远被波动伤害。

**不要试图预测未来。要构建无论未来如何，你都能受益的位置。**
