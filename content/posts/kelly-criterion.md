...
部分凯利牺牲了一些期望收益，换取更平稳的路径和更大的安全边际。
...
两者的差别在遍历性文章中已经解释过：在乘性系统中，时间平均才是你真正经历的。
...
在一个充满不确定性的世界里，凯利公式提供了一个锚点：**一种平衡利用机会和管理风险的数学方法**。

理解它不会让你成为更好的预测者。但它会让你成为更好的资金管理者。
...
- Edward Thorp: "Beat the Dealer" 和 "A Man for All Markets"
