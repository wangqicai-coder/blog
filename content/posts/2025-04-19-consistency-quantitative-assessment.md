...
## 核心概念：Consistency Assessment

### 定义与本质


Consistency Assessment是交易心理学中的核心概念之一。
...
从心理学角度看，Consistency Assessment的作用机制可以分解为：
...
Denise Shull在《Market Mind Games》中引用了大量神经科学研究，揭示了Consistency Assessment的大脑机制：
...
**心理机制**：
此时Consistency Assessment正在通过"预期焦虑"发挥作用。你的大脑在做两件事：
1. 预测可能的损失（杏仁核激活）
2. 想象错过机会的后悔（FOMO）
...
**心理机制**：
持仓期间，Consistency Assessment制造了一个"心理牢笼"：
...
**心理机制**：
离场时刻，Consistency Assessment达到巅峰：
...
**目标**：捕捉Consistency Assessment在你思维中的实时运作
...
**目标**：理解为什么Consistency Assessment会在特定情境下被激活
...
**目标**：建立新的应对Consistency Assessment的行为模式
...
作为心理学家和交易教练，我想和你分享关于一致性的量化评估的三个进阶思考：
